...
```typescript TypeScript
// Wildcard matches everything
passport.hasPermission('anything');  // true if permissions contains "*"

// Prefix wildcard
passport.hasPermission('mcp:search');  // true if permissions contains "mcp:*"

// Exact match
passport.hasPermission('mcp:search');  // true if permissions contains "mcp:search"
```
</CodeGroup>
